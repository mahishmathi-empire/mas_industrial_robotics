#ifndef MIR_MOVE_BASE_SAFE__MOVE_BASE_SAFE_HPP_
#define MIR_MOVE_BASE_SAFE__MOVE_BASE_SAFE_HPP_
...
class MoveBaseSafeAction : public BT::StatefulActionNode
{
public:
  MoveBaseSafeAction(const std::string& name,
...
#endif  // MIR_MOVE_BASE_SAFE__MOVE_BASE_SAFE_HPP_